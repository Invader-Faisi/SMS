 <?php
    ...
    class extends Component {
        ...
        {
            return [
                'classes' => $classServices->getClassesList(),
            ];
        }
         ...
         @foreach($classes as $class)
             <article
                 ...
                 <div class="flex flex-col gap-2 p-6 text-center mt-2">
                     <h3 class="h-14 text-balance text-lg font-bold text-on-surface-strong lg:text-xl dark:text-on-surface-dark-strong">
                         {{$class->teacher->name}}</h3>
                     <span
                     ...
                     <div class="mt-4 flex items-center justify-center gap-6">
                         ...
                         <flux:button tooltip="View Class Strength" variant="primary" color="green" size="xs"
                                      class="cursor-pointer">
                             <a href="{{ route('admin.classes.class', $class->class_id) }}">
